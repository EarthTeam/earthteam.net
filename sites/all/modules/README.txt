...
You will not be able to uses Drupal's module installation feature (by URL or upload), 
unless you change permissions or ownership of this directory, temporarily.

To do that, at an ssh shell command line, issue the following command:

cd /var/www/html
sudo chown -R www-data:terra sites/all/modules

...then use the Drupal admin interface to install the module.

...then:
sudo chown -R terra:www-data sites/all/modules

...to secure the modules directory.
